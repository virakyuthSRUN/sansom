      ...
      <div className="flex min-h-screen bg-background">
        ...
        <aside className="w-[260px] bg-card border-r border-border flex flex-col py-6 px-3 flex-shrink-0 sticky top-0 h-screen">
          ...
          <div className="flex items-center gap-2.5 px-3 mb-8">
            <div className="w-9 h-9 rounded-xl  flex items-center justify-center shadow-primary">
              <img
                src="public/favicon.ico" // Replace with your logo icon path
                alt="Logo"
                className="w-5 h-5 object-contain"
              />
            </div>
            <span className="text-lg font-extrabold text-foreground font-display tracking-tight">
              SAMSOM
            </span>
          </div>
  ...
  return (
    <div className="flex min-h-screen bg-background">
      <div className="w-full max-w-2xl mx-auto flex flex-col min-h-screen">
        ...
        {/* Bottom Nav */}
        <div
          className="bg-card/80 backdrop-blur-sm border-t border-border px-1 pt-1 pb-safe flex justify-around items-end flex-shrink-0 sticky bottom-0 z-10"
